...
export const createUploadHandler = (
  uploadService: Pick<UploadService, 'processCsvData'> = new UploadService(),
): RequestHandler => {
...
export const createUploadController = (
  uploadService: Pick<UploadService, 'processCsvData'> = new UploadService(),
  uploadMiddleware: UploadMiddleware = upload,
) => {
  const uploadController = Express.Router();
  uploadController.post(
    '/upload',
    uploadMiddleware.single('data'),
    createUploadHandler(uploadService),
  );
